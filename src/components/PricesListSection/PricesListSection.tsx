    ...
    return (
        <SectionBackground backgroundDivClassNames='bg-[#F5F5F5] h-[970px]'>
            <div className='container'>
                ...
                <div className="lg:grid lg:grid-cols-3 flex flex-col pb-[93px] gap-[30px]">
                    {
                        pricesData.map(type => {
                            ...
                            return (
                                <div>
                                    <h2 className="text-[#423930] md:text-[24px]leading-[24px] pt-[30px] font-gotu" key={id}>{serviceType}</h2>
