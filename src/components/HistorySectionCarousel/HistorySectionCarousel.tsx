                    ...
                    createPortal(
                        <div className='fixed w-screen h-screen top-0 left-0 flex justify-center bg-black bg-opacity-80 z-50'>
                            ...
                            <div className='flex justify-center align-middle'>
                                ...
                                <div className='relative'>
                                    <img id='' src={arrow} onClick={handlePrevImage} className='absolute w-[200px] p-[20px] rounded-full bg-white rotate-180 top-[47rem] left-[4rem] mx-auto aaaooo' alt='' />
                                    <img src={arrow} onClick={handleNextImage} className='absolute w-[200px] p-[20px] rounded-full bg-white top-[47rem] right-[4rem] mx-auto' alt='' />
                                </div>
                            </div>
                        </div>
