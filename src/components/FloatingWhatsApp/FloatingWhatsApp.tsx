...
import darkBG from '../../assets/images/bg-chat-tile-light.png'
import lightBG from '../../assets/images/bg-chat-tile-dark.png'
import dummyAvatar from '../../assets/images/uifaces-avatar.jpg'
...
export default function FloatingWhatsApp({
  ...
  useEffect(() => {
    setTimeout(() => {
      const btn = document.getElementsByClassName("floating-whatsapp-button")?.[0];
      // console.log('btn',btn)
      // @ts-ignore
