        ...
        <SectionBackground wrapperClassNames='lg:h-[1050px] h-[950px] mt-[162px] mb-[252px] overflow-hidden' backgroundDivClassNames='bg-[#B2A285]' >
            ...
            <div className='flex flex-col-reverse lg:grid lg:grid-cols-2 justify-center items-center container'>
                ...
                <div className='lg:ml-[151px] lg:mt-[142px] mt-[64px] px-4 mx-auto'>
                    ...
                    <ButtonPrimary onClick={handleBookingClick} type="button" className='lg:w-[229px] lg:h-[60px] w-[178px] h-[47px] mt-[30px] box-border border-2 border-[#fff]'>
                        <a href='/booking'><span className="font-gotu font-normal lg:text-[22px] text-[#fff] leading-[28px] tracking-[0.02em] text-[16px] ">Book Now</span></a>
