...
const OurServices: FC = () => {
    return (
        <div className='container'>
            <h2 className='text-white text-[64px] font-gotu leading-[74px] tracking-tighter'>Our <br /> Services</h2>
...
const ServiceCard: FC<ServiceCardProps> = (props) => {
    ...
    return (
        <div className='border border-[#EEEEEE] py-[42px] px-[35px] space-y-[30px]' key={id}>
